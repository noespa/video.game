...
<div class="container mx-auto px-4">
    <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
        <div class="flex-none">
            <img src="{{ $game['coverImg'] }}" alt="Game cover" class="w-72">
        </div>
        <div class="lg:ml-12 lg:mr-64">
            <h2 class="font-semibold text-4xl leading-tight mt-1">{{ $game['name'] }}</h2>
            <div class="text-gray-400">
                <span>{{ $game['genresName'] }}</span>
                &middot;
                <span>{{ $game['companyName'] }}</span>
                &middot;
                <span>{{ $game['platformsName'] }}</span>
            </div>
            ...
            <div class="mt-12">
                <a href="{{ $game['trailer'] }}" class="inline-flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition
                ease-in-out duration-150">
                    ...
                    </svg><span class="ml-2">Play Trailer</span>
                </a>
                {{-- <button
            ...
            <div>
                <a href="{{ $screenshot['huge'] }}">
                    <img src="{{ $screenshot['big'] }}" alt="screenshot"
                        class="object-cover w-full h-64 hover:opacity-75 transition ease-in-out duration-150">
                </a>
            </div>
            @endforeach
        </div>
