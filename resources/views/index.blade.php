            ...
            <div class="recently-reviewed-container mt-8 space-y-12">
                <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                    ...
                    <div class="ml-12">
                        ...
                        <div class="text-gray-400 mt-1">Playstation 4</div>
                        <p class="mt-6 text-gray-400 hidden lg:block">Lorem, ipsum dolor sit amet consectetur
                            adipisicing elit.
                            Perferendis nisi cum officia provident ad voluptatibus, reiciendis accusamus pariatur itaque
                            aliquam, non tempore cumque unde aut. Eum repellendus odit ea exercitationem.</p>
                    </div>
                </div>
                <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                    <div class="relative flex-none">
